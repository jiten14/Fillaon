            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-sm text-primary-700 dark:text-primary-300">
                        Generate role-based access control policies for your models. Select a model, configure permissions for each role, and generate a comprehensive policy class with just a few clicks.
                    </p>
                </div>
            </div>
        </div>
        ...
        <form wire:submit="generate" class="space-y-6">
            ...
            <div class="flex items-center justify-between gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <span>Configure role-based permissions for your model</span>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        <span class="flex items-center gap-2">
                            ...
                            <x-heroicon-s-shield-check class="w-5 h-5" wire:loading.remove wire:target="generate"/>
                            <span class="font-semibold" wire:loading.remove wire:target="generate">Generate Policy</span>
                            <span class="font-semibold" wire:loading wire:target="generate">Generating...</span>
                        </span>
                    </x-filament::button>
                </div>
            </div>
